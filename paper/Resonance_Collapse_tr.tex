...
\title{Resonance Collapse: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Resonance Collapse'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
